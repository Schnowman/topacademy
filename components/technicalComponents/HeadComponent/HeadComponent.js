    ...
    return (
      <>
        <Head>
          ...
          {this.props.socialTags &&
            Object.entries(this.props.socialTags).map(getTagElement)}
          {this.state.loaded && (
            <link
              rel="stylesheet"
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `var Tawk_API=Tawk_API||{ }, Tawk_LoadStart=new Date();
					...
					s1.async=true;
					s1.src='https://embed.tawk.to/677bce2d49e2fd8dfe032d1e/1igtpqpag';
					s1.charset='UTF-8';
