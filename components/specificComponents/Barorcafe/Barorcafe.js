  ...
  render() {
    return (
      <div {...storyblokEditable(this.props.blok)}>
        ...
        <main>
          <Hero blok={this.props.blok} contentTypeTag="barorcafe" />{" "}
          ...
          <div className={css["barorcafe-page__main-content"]}>
            <div
              id="barorcafe-page__short-description"
              key="barorcafe-page__short-description"
              className={css["barorcafe-page__short-description"]}
            >
