  ...
  render() {
    return (
      <div {...storyblokEditable(this.props.blok)}>
        ...
        <main>
          <Hero blok={this.props.blok} contentTypeTag="restaurant" />{" "}
          {/*This code displays the hero section (title and image)*/}
          {/*The following code displays the intro/description*/}
          <div className={css["restaurant-page__main-content"]}>
            <div
              id="restaurant-page__short-description"
              key="restaurant-page__short-description"
              className={css["restaurant-page__short-description"]}
            >
